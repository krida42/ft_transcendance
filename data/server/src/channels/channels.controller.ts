...
export class ChannelsController {
  ...
  async deleteChannel(@Req() req: ReqU, @Param('chanId') chanId: uuidv4) {
    return this.channelService.deleteChannel(req.user.public_id, chanId);
  }
  ...
  async quitChannel(@Req() req: ReqU, @Param('chanId') chanId: uuidv4) {
    return this.channelService.quitChannel(req.user.public_id, chanId);
  }
  ...
  async addAdmin(
    ...
    return this.channelOpService.addAdmin(req.user.public_id, chanId, userId);
  }
  ...
  async delAdmin(
    ...
    return this.channelOpService.delAdmin(req.user.public_id, chanId, userId);
  }
  ...
  async inviteToChannel(
    ...
    return this.channelOpService.invite(req.user.public_id, chanId, userId);
  }
  ...
  async uninviteToChannel(
    ...
    return this.channelOpService.uninvite(req.user.public_id, chanId, userId);
  }
  ...
  async banUser(
    ...
    return this.channelOpService.banUser(req.user.public_id, chanId, userId);
  }
  ...
  async unbanUser(
    ...
    return this.channelOpService.unbanUser(req.user.public_id, chanId, userId);
  }
  ...
  async muteUser(
    ...
    return this.channelOpService.mute(req.user.public_id, chanId, userId);
  }
  ...
  async kickUser(
    ...
    return this.channelOpService.kick(req.user.public_id, chanId, userId);
  }
  ...
  async getJoinedChan(@Req() req: ReqU) {
    return this.channelGetService.getJoinedChan(req.user.public_id);
  }
  ...
  async getDirectChan(@Req() req: ReqU) {
    return this.channelGetService.getDirectChan(req.user.public_id);
  }
