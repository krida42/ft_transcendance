...
export class FriendsController {
  ...
  async createFriendRequest(@Req() req : Request, @Param('userId') userId: uuidv4) {
  ...
  async acceptFriendRequest(@Req() req : Request, @Param('userId') userId: uuidv4) {
    return this.friendsService.acceptFriend(this.public_id, userId);
  }

  @ApiOperation({ summary: 'Decline a friend request' })
  @Delete('/friends/:userId/decline')
  async declineFriendRequest(@Req() req : Request, @Param('userId') userId: uuidv4) {
  ...
  async cancelFriendRequest(@Req() req : Request, @Param('userId') userId: uuidv4) {
    return this.friendsService.deleteFriend(this.public_id, userId);
  }
